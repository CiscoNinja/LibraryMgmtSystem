      				...
      				<div class="box">
      					...
      					<div class="box-body table-responsive">
      						<table id="example1" class="table table-bordered table-striped">
      							...
      							<tbody>
      								<tr>
      									<td align="center" valign="middle">Trident</td>
      									<td align="center" valign="middle">Internet Explorer 4.0</td>
      									<td align="center" valign="middle"><button style="width:70px">Active</button></td>
      									<td align="center" valign="middle"><button style="width:70px">Edit</button><button style="width:70px">Delete</button></td>
      								</tr>
      							</tbody>
      						</table>
      					</div><!-- /.box-body -->
